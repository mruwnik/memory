...
# --- Check job queue ---------------------------------------------------------
CHECK_LEASE_TTL_SEC = int(os.getenv("CHECK_LEASE_TTL_SEC", "3600"))  # 1h lock
CHECK_JOB_TTL_SEC = int(os.getenv("CHECK_JOB_TTL_SEC", str(14 * 24 * 3600)))  # 14d retention
CHECK_QUEUE_MAX_DEPTH = int(os.getenv("CHECK_QUEUE_MAX_DEPTH", "100"))
CHECK_MAX_TEXT_BYTES = int(os.getenv("CHECK_MAX_TEXT_BYTES", str(64 * 1024)))
CHECK_MAX_LONG_POLL_SEC = int(os.getenv("CHECK_MAX_LONG_POLL_SEC", "30"))
CHECK_CALLBACK_TIMEOUT_SEC = int(os.getenv("CHECK_CALLBACK_TIMEOUT_SEC", "10"))
CHECK_CALLBACK_MAX_ATTEMPTS = int(os.getenv("CHECK_CALLBACK_MAX_ATTEMPTS", "3"))
CHECK_MAX_REQUEUE_ATTEMPTS = int(os.getenv("CHECK_MAX_REQUEUE_ATTEMPTS", "3"))
CHECK_RATE_LIMIT_PER_MIN = int(os.getenv("CHECK_RATE_LIMIT_PER_MIN", "60"))
